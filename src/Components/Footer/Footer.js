...
<div className="newslater-section padding-bottom">
  <div className="container">
    <div
      ...
      data-background="http://www.tazkara2go.com:805/assets/images/newslater/newslater-bg01.jpg"
    >
...
<div className="container">
  <div className="footer-top">
    <div className="logo">
      <a href="index-1.html">
        <img src="http://www.tazkara2go.com:805/assets/images/footer/footer-logo.png" alt="footer" />
      </a>
    </div>
